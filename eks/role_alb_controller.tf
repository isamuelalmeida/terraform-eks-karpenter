module "iam_assumable_role_alb" {
  ...
  create_role      = true
  role_name        = "alb-controller-${module.env_info.envs[terraform.workspace].eks.cluster_name}"
  provider_url     = replace(module.eks.cluster_oidc_issuer_url, "https://", "")
  role_policy_arns = [aws_iam_policy.aws_load_balancer_controller_policy.arn]
}

resource "aws_iam_policy" "aws_load_balancer_controller_policy" {
  name = "alb-controller-policy-${module.env_info.envs[terraform.workspace].eks.cluster_name}"
  path = "/"
